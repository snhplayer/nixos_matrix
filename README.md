...
> [!WARNING]
> Критическая масса нейрослопа ahead, будьте осторожны!!!
...
Для деплоя с использованием этого модуля на VPS/VDS необходимо сменить ОС на купленном сервере, либо использовать другой скрипт, например [этот](https://codeberg.org/Svyatoclav/umo). Если хостинг не предоставляет нативной возможности установки NixOS, то можно воспользоваться скриптом [nixos-infect](https://github.com/elitak/nixos-infect). Далее будет пример установки для хостинга beget.com.
